...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed right-5 bottom-24 lg:bottom-6 z-30 w-13 h-13 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] text-white flex items-center justify-center shadow-xl shadow-black/15 hover:scale-105 transition-all"
    >
